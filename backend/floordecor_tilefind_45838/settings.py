"""
Django settings for floordecor_tilefind_45838 project.
...
ROOT_URLCONF = 'floordecor_tilefind_45838.urls'
...
WSGI_APPLICATION = 'floordecor_tilefind_45838.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floordecor_tilefind_45838 API",
    "DESCRIPTION": "API documentation for floordecor_tilefind_45838 App",
    "VERSION": "v1",
}
